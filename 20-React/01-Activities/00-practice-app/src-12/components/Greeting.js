...
function Greeting() {
  // TODO: Convert `greeting` to a state variable using the useState hook. 
  // Give it a initial value of 'Welcome the following students to class!'
  // let greeting = 'Welcome the following students to class!';
  const [greeting, setGreeting] = useState('Welcome! Say hello to the Students!');
  ...
  const group = ['Alexa', 'Lars', 'Clayton', 'Will', 'Monique', 'Kevin'];
